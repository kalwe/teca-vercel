...
// import { deletedJson } from "../data/address"
...
const addressList: AddressTypeMock[] = []
...
export function createAddressMock(data_mock: AddressTypeMock): AddressTypeMock[] {
    data_mock.id = Math.floor(Math.random() * 6) + 1
    // const validatedAddress = addressSchema.parse(data_mock)
    // Add to the list
    addressList.push(data_mock)
...
export function getAddressByIdMock(id: number): AddressTypeMock | null {
...
export function getAllAddressesMock(): AddressTypeMock[] {
    return addressList
}
 ...
 */
// function updateAddress(id: number, updated_data_mock: Partial<AddressSchema>): AddressSchema | null {
export function updateAddressMock(id: number, updated_data_mock: Partial<AddressTypeMock>): AddressTypeMock | null {
    ...
    addressList[index] = { ...addressList[index], ...updated_data_mock }
 ...
 */
export function deleteAddressMock(id: number): boolean {
    // Find index of the address with the given ID
    const index = addressList.findIndex(address => address.id === id)
...
// Example usage:
// const newAddress: AddressTypeMock = {
//     street: "456 Elm St",
//     number: "12B",
//     neighborhood: "Uptown",
//     city: "Metropolis",
