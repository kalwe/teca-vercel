...
export function VisualizeCV() {
  ...
  return (
    <div>
      {/* Main Container */}
      <div className="text-white flex justify-center items-center min-h-screen bg-transparent"
      style={{
            ...
            {curriculos.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-4">
                {curriculos.map((curriculo) => (
                  ...
                  >
                    <h1 className="text-gray-300 font-semibold">{curriculo.nome}</h1>
                    <button
                      className="p-2 bg-transparent hover:bg-gray-600 rounded-md"
                      onClick={(e) => {
                        e.stopPropagation();
