...
function NovaVaga() {
  ...
  /**
   * 🔹 Carrega os cargos da API a partir das vagas existentes
   */
  useEffect(() => {
  ...
  /**
   * 🔹 Carrega dados da vaga em modo de edição
   */
  useEffect(() => {
    if (isEditMode) {
  ...
  /**
   * 🚀 Manipula o envio do formulário - Cria ou Atualiza uma vaga na API e no contexto
   */
