...
export const cvSchema = z.object({
  ...
  education_level: z
    .string()
    .min(2, "O nível de escolaridade deve ter pelo menos 2 caracteres")
    .max(50, "O nível de escolaridade deve ter no máximo 50 caracteres")
    .trim(),
  ...
  date_of_birth: z
    ...
    pdf_url: z
    .string()
    .trim() // Aplica trim antes de regex
